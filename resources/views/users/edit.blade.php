<x-app-sidebar-layout title="{{ __('users.edit') }}">
    ...
    <style>
      ...
      .uform .note{font-size:13px;color:var(--muted-2);margin-bottom:18px}
    ...
    <div class="form-card uform">
        <form action="{{ route('users.update', $user) }}" method="POST">
            ...
            <p class="note">{{ __('users.pw_note') }}</p>

            <div class="form-actions">
                <button type="submit" class="btn-amber">{{ __('users.update_btn') }}</button>
